...
export default class Game {
    ...
    restartGame() {
        ...
        // this.orange.drawOrange(this.orange.ctx);
        // this.cloud.drawCloud(this.cloud.ctx);
        // this.detectOrangeCollision();
